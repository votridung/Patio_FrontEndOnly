...
@Component({
  selector: 'app-tao-moi-ho-so-kham-benh',
  templateUrl: './tao-moi-ho-so-kham-benh.page.html',
  styleUrls: ['./tao-moi-ho-so-kham-benh.page.scss'],
})
export class TaoMoiHoSoKhamBenhPage implements OnInit {
    gioitinh = 'Chọn';
    quocgia = 'Việt Nam';
    tinhthanh = 'Chọn';
    quanhuyen = 'Chọn';
    ...
    xacnhanthongtin(){
      this.router.navigate(['kiem-tra-thong-tin']);
    }
    taohsnb(){
